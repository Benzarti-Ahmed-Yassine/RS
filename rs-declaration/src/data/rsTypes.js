...
export const RS_TYPES = {
  RS1: [
    ...
    { id: 'RS1_000002', desc: 'Loyers servis à des résidents établis', taux: 10 },
  ],
  RS2: [
    { id: 'RS2_000001', desc: 'Honoraires BNC — forfait d\'assiette, commissions, courtages, rémunérations non commerciales', taux: 10 },
    { id: 'RS2_000002', desc: 'Honoraires BNC régime réel — résidents établis', taux: 3 },
    { id: 'RS2_000003', desc: 'Rémunérations en contrepartie de la performance', taux: 10 },
    { id: 'RS2_000004', desc: 'Rémunérations artistes, créateurs soumis à l\'IR régime réel ou PM (production, diffusion, œuvres)', taux: 10 },
  ],
  RS3: [
  ...
  RS6: [
    { id: 'RS6_000001', desc: 'Cession de fonds de commerce par les PM et PP résidentes', taux: 2.5 },
  ...
  RS7: [
    ...
    { id: 'RS7_000002', desc: 'Acquisitions ≥ 1 000 D (TVA incluse) — PP et PM soumises IS taux 15%', taux: 1 },
    { id: 'RS7_000003', desc: 'Acquisitions ≥ 1 000 D (TVA incluse) — PP (déduction 2/3) et PM IS taux 10%', taux: 0.5 },
    { id: 'RS7_000004', desc: 'Commission distributeurs agréés opérateurs télécommunications (personne physique)', taux: 1.5 },
    { id: 'RS7_000005', desc: 'Commission distributeurs agréés opérateurs télécommunications (personne morale)', taux: 1 },
  ],
  RS8: [
  ...
  RS11: [
    { id: 'RS11_000001', desc: 'Jeux de pari et loterie (hors paris mutuels courses de chevaux et concours de pronostics sportifs)', taux: 25 },
  ],
}
